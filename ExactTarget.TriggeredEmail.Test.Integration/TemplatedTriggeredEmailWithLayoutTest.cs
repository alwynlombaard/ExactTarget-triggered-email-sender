...
{
    public class TemplatedTriggeredEmailWithLayoutTest : TestBase
    {
        [Test]
        public void Create_And_Send_A_Templated_Triggered_Email_With_Custom_LayoutHtml_And_Custom_Replacement_Fields()
        {
