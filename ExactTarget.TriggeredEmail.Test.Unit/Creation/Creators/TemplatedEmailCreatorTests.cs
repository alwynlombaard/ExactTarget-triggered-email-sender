...
{
    [TestFixture]
    public class TemplatedEmailCreatorTests
    {
        ...
        private TemplatedEmailCreator ManufactureCreator()
        {
            return new TemplatedEmailCreator(_dataExtensionClient.Object, 
        ...
        [Test]
        public void When_Creating_An_Email_A_DataExtension_With_Head_Field_Is_Created()
        {
            var creator = ManufactureCreator();
            creator.Create("external-key", "<p>email markup</p>");
            ...
            _dataExtensionClient.Verify(d => d.CreateDataExtension(
                    ...
                    It.IsAny<string>(),
                    "triggeredsend-external-key",
                    It.Is<HashSet<string>>(values => values.Contains("Head"))),
                Times.Once);
        }

        [Test]
        public void When_Creating_An_Email_A_DataExtension_With_Body_Field_Is_Created()
        {
            var creator = ManufactureCreator();
            creator.Create("external-key", "<p>email markup</p>");
            ...
            _dataExtensionClient.Verify(d => d.CreateDataExtension(
                    ...
                    It.IsAny<string>(),
                    "triggeredsend-external-key",
                    It.Is<HashSet<string>>(values => values.Contains("Body"))),
                Times.Once);
        }
